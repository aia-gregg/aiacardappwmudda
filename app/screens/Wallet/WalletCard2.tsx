...
type WalletCard2NavigationProp = StackNavigationProp<RootStackParamList, 'CardSelect'>;

type Props = {
  color?: string;
};

const WalletCard2 = ({ color }: Props) => {
  const { colors } = useTheme();
  const navigation = useNavigation<WalletCard2NavigationProp>();
